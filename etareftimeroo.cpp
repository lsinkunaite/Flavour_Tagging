...
{ 
    ...
    RooRealVar time("obsTime", "obsTime", obsTime_lower_bound, obsTime_upper_bound);
    ...
    RooAddPdf PDF_Mass_Sig("PDF_Mass_Sig_Comp", "PDF_Mass_Sig_Comp", RooArgList(PDF_Mass_Sig, PDF_Mass_Sig2), RooArgList(nFrac));
    ...
    RooAddPdf pdf_mass("model_mass","model_mass",RooArgList(PDF_Mass_Sig, PDF_Mass_Bkg), RooArgList(nSig, nBkg));
